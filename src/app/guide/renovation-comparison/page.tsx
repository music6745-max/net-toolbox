  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="mb-10">
        ...
        <ComparisonTableCTA
          services={[
            { name: "タウンライフリフォーム", url: "https://px.a8.net/svt/ejp?a8mat=4B1DXI+4XF71U+35XE+609HU", highlight: "プラン提案も無料", price: "完全無料", badge: "おすすめ" },
            { name: "ホームプロ", url: "https://px.a8.net/svt/ejp?a8mat=4B1DXI+1UOKJ6+3SPO+9FDI8Y", highlight: "利用者90万人の老舗", price: "完全無料" },
            { name: "リショップナビ", url: "https://px.a8.net/svt/ejp?a8mat=4B1DXI+4W8BUA+4JGQ+60WN6", highlight: "コンシェルジュ付き", price: "完全無料" },
          ]}
        />
      </section>

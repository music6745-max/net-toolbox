...
export default function CordlessCleanerComparisonPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">家電の電気代・周辺見直しツール</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Link href="/tools/appliance-electricity-cost" className="block bg-card-bg border border-card-border rounded-xl p-4 hover:shadow-lg hover:border-primary/30 transition-all duration-200">
            ...
            <p className="text-xs text-muted mt-1">掃除機の電気代を概算</p>
          </Link>
          <Link href="/tools/electricity-cost" className="block bg-card-bg border border-card-border rounded-xl p-4 hover:shadow-lg hover:border-primary/30 transition-all duration-200">
            ...
            <p className="text-xs text-muted mt-1">月間・年間の電気代を確認</p>
          </Link>
          <Link href="/guide/air-purifier-comparison" className="block bg-card-bg border border-card-border rounded-xl p-4 hover:shadow-lg hover:border-primary/30 transition-all duration-200">
            ...
            <p className="text-xs text-muted mt-1">掃除とあわせて空気環境も見直し</p>
          </Link>
        </div>
      </section>

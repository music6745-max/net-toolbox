...
export default function RiceCookerComparisonPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">炊飯器まわりの費用を見直すツール</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Link href="/tools/appliance-electricity-cost" className="block bg-card-bg border border-card-border rounded-xl p-4 hover:shadow-lg hover:border-primary/30 transition-all duration-200">
            <span className="text-sm font-bold hover:text-primary">家電の電気代計算</span>
            <p className="text-xs text-muted mt-1">炊飯器の月間電気代を概算</p>
          </Link>
          <Link href="/tools/electricity-cost" className="block bg-card-bg border border-card-border rounded-xl p-4 hover:shadow-lg hover:border-primary/30 transition-all duration-200">
            <span className="text-sm font-bold hover:text-primary">電気料金計算</span>
            <p className="text-xs text-muted mt-1">調理家電全体の電気代確認に</p>
          </Link>
          <Link href="/guide/meal-kit-comparison" className="block bg-card-bg border border-card-border rounded-xl p-4 hover:shadow-lg hover:border-primary/30 transition-all duration-200">
            ...
            <p className="text-xs text-muted mt-1">自炊まわりの時短も見直す</p>
          </Link>
        </div>
      </section>

      ...
      <section className="mb-8">
        ...
        <ComparisonTableCTA
          services={[
            {
              name: "ネイティブキャンプ",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+APTO2+35VG+64JTE",
            ...
            {
              name: "NOVA ライブステーション",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+EAFAQ+320A+BXIYP",
              highlight: "LIVE配信で学ぶオンライン英会話",
              price: "月額980円〜",
            },
            {
              name: "QQ English",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+A4E2A+4HHM+639IP",
              highlight: "プロ教師によるカランメソッド",
              price: "月2,980円〜",
            },
            {
              name: "ベストティーチャー",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+7QNN6+2ZIK+69HA9",
              highlight: "Writing×Speakingの独自メソッド",
              price: "月12,000円〜",
            },
            {
              name: "LanCul（ランカル）",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+5YCTU+4FL0+HWPVL",
            ...
            {
              name: "AQUES（アクエス）",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+4RHMA+4D4Y+61C2Q",
              highlight: "日本人×外国人のハイブリッド",
              price: "月額制",
            },
            {
              name: "NovaKid",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+D3K36+4KYW+63OY9",
              highlight: "4〜12歳向け・ネイティブ講師",
              price: "月額制",
              badge: "子供向け",
            },
            {
              name: "エイゴックス",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+EVUWI+2TKO+5ZU2A",
              highlight: "ネイティブ・日本人・フィリピン人講師",
              price: "月2,700円〜",
            },
            {
              name: "クラウティ",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+5CX82+46SW+5YJRM",
              highlight: "家族6人までアカウント共有OK",
              price: "月4,950円〜",
              badge: "家族向け",
            },
            {
              name: "ワールドアイキッズ",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+7581E+4MZ4+5YZ77",
              highlight: "子供専門オンライン英会話",
              price: "月2,450円〜",
              badge: "子供向け",
            },
            {
              name: "キーアイ",
              url: "https://px.a8.net/svt/ejp?a8mat=4B1DXO+9IYGI+4MZ4+BYLJL",
              highlight: "コーチング型英会話スクール",
              price: "月額制",
            },
          ]}
        />

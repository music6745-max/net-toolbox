...
export const tools: Tool[] = [
  ...
  { slug: "kaigo-family-duty-role-share-memo", name: "介護家族 当番・役割分担 記録メモメーカー", description: "担当エリア、月次当番、活動実績、役割変更を同じ形式で整理し、家族で共有できるメモを生成。", icon: "🔁", category: "日常ツール" },
  ...
  { slug: "kaigo-parent-regular-delivery-package-receipt-memo", name: "実家 定期便・宅配便 受け取りメモメーカー", description: "実家に届くもの、頻度、受け取り方、月別予定、次に確認することを家族で整理。", icon: "📦", category: "日常ツール" },
  ...
  { slug: "kaigo-parent-home-cleaning-laundry-housework-routine-memo", name: "高齢親 掃除・洗濯・家事ルーティン共有メモメーカー", description: "掃除、洗濯、ゴミ出しなどの家事タスクを頻度別に整理し、担当と申し送りメモを生成。", icon: "🧹", category: "日常ツール" },
